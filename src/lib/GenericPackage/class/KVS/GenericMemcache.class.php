...
class GenericMemcache {
	...
	/**
	 */
	public static function start($argDSN = NULL){
		self::_initMemcache($argDSN);
	}

	/**
	 */
	public static function get($argKey, $argDSN = NULL){
		$instanceIndex = self::_initMemcache($argDSN);
	...
	/**
	 */
	public static function set($argKey, $argVal, $argCompressedFlag = FALSE, $argExpire = 0, $argDSN = NULL){
		$instanceIndex = self::_initMemcache($argDSN);
	...
	/**
	 */
	public static function increment($argKey,$argCnt=1, $argDSN = NULL){
		$instanceIndex = self::_initMemcache($argDSN);
	...
	/**
	 */
	public static function decrement($argKey,$argCnt=1, $argDSN = NULL){
		$instanceIndex = self::_initMemcache($argDSN);
	...
	/**
	 */
	public static function add($argKey, $argVal, $argCompressedFlag = FALSE, $argExpire = 0, $argDSN = NULL){
		$instanceIndex = self::_initMemcache($argDSN);
	...
	/**
	 */
	public static function delete($argKey, $argExpire = 0, $argDSN = NULL){
		$instanceIndex = self::_initMemcache($argDSN);
	...
	/**
	 */
	public static function replace($argKey, $argVal, $argCompressedFlag = FALSE, $argExpire = 0, $argDSN = NULL){
		$instanceIndex = self::_initMemcache($argDSN);
	...
	/**
	 */
	public static function flush($argDSN = NULL){
		$instanceIndex = self::_initMemcache($argDSN);
	...
	/**
	 */
	public static function quit($argDSN = NULL){
		$instanceIndex = self::_initMemcache($argDSN);
